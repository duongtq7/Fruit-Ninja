    ...
    with MP_POSE.Pose(
        ...
        while cap.isOpened() and running:
            ...
            if type(start_fruit) is Fruit: 
                ...
                points_text = MAIN_NUMBER_FONT.render(f'Score: {total_points}', False, RED)
                screen.blit(points_text, (
                    round(GAME_WIDTH / 2) - points_text.get_width() / 2, 
                    round(GAME_HEIGHT / 2) - points_text.get_height() / 2))
                ...
                if keys_pressed[pygame.K_r]:
                    ...
                    cap = cv2.VideoCapture(1)  # Re-open the camera
